...
def test_grounded_ai_routes_install_without_replacing_existing_surface(tmp_path, monkeypatch):
    ...
    assert app.state.dashboard_ui_revision == "professional-v1.9-live-youtube-health-native-cache"
    ...
    assert app.state.dashboard_connection_health_installed is True
