...
def test_grounded_ai_routes_install_without_replacing_existing_surface(tmp_path, monkeypatch):
    ...
    assert app.state.dashboard_ui_revision == "professional-v1.11-fast-independent-boot"
    ...
    # fetch wrapping, or passive API probing must not be active in this revision.
