...
ERROR_MESSAGES: dict[str, str] = {
    ...
    "metadata_limit_exceeded": "The proposed YouTube metadata exceeds an official field limit.",
    "thumbnail_source_invalid": "Exactly one safe thumbnail source is required and the supplied source is invalid.",
    "thumbnail_source_unavailable": "The approved thumbnail source could not be resolved safely.",
    "thumbnail_file_not_found": "The authorized ChatGPT file could not be found or its temporary download expired.",
    "thumbnail_file_unauthorized": "The ChatGPT file reference is not authorized for this plugin context.",
    "thumbnail_file_resolution_failed": "The ChatGPT file reference could not be resolved to bytes safely.",
    "thumbnail_asset_not_found": "The tenant thumbnail asset was not found.",
    "thumbnail_asset_unauthorized": "The tenant thumbnail asset is not authorized in this context.",
    "thumbnail_too_large": "The thumbnail source exceeds the configured safe input size.",
    "thumbnail_decode_failed": "The thumbnail image could not be decoded safely.",
    "thumbnail_format_unsupported": "The thumbnail input format is not supported by the safe normalizer.",
    "thumbnail_normalization_failed": "The thumbnail could not be normalized to a YouTube-compatible output.",
    "thumbnail_staging_failed": "The approved thumbnail staging operation failed or was already consumed.",
    "thumbnail_staging_expired": "The staged thumbnail has expired or is no longer available.",
    "thumbnail_hash_mismatch": "The staged thumbnail bytes do not match the approved SHA-256.",
    "thumbnail_validation_failed": "The proposed thumbnail failed safe validation.",
    "thumbnail_write_failed": "YouTube rejected or could not complete the thumbnail update.",
    "thumbnail_verification_failed": "The thumbnail write returned but persistence could not be verified safely.",
    "baseline_changed": "The protected YouTube resource changed after preview; generate a new preview.",
